    ...
    <script>
        ...
        var wfsgeoserver1 = L.geoJson(null, {
            style: function (feature) {
                    ...
                    var value = feature.properties.jml22; // Change this to your actual property name
                    return {
        ...
        title.update = function () {
            this._div.innerHTML =
                "<h4> Peta Jumlah UMKM menurut Wilayah di Kabupaten Sleman </h4>Berdasarkan data Pemerintah Kabupaten Sleman";
        };
        title.addTo(map);
        ...
        map.addLayer(markers);
            ...
            function getColor(value) {
                return value < 3644
                    ? "#fee5d9"    // Warna merah muda untuk nilai di bawah 50000
                    : value >= 3644 && value <= 5045
                        ? "#fcae91"  // Warna merah 
                        : value > 5045
                            ? "#a50f15" // Warna merah tua 
                            : "#fff5f0"; // Warna default 
            }
    </script>
</body>
